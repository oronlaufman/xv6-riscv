...
//   }
//   for(int i=0;i<NUM_OF_CHILDREN;++i){wait(&i);}
...
//   printf("Child stopped! Sending child a signal, sleep for 10 and then continuing the child.\n");
//   kill(child,4);
//   sleep(10);
//   kill(child,SIGCONT);
//   while(isStopped(child));
